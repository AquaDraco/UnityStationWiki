...
* DragApply - (TODO: MouseDrop should maybe be refactored into this) dragging and dropping an item from a UI slot to the game world. Usually this drops the item on the ground, but if you drag a container into another container you pass the items to it. There may be other cases.
